...
namespace Movie_App_MinimalApi.Endpoints
{
    public static class GenresEndpoints
    {
        ...
        static async Task<Ok<List<GenreDTO>>> GetAll(IGenreRepository genreRepository)
        {
            var genres = await genreRepository.GetAll();

            var genresDTO = genres.Select(genre => new GenreDTO
            {
                Id = genre.Id,
                Name = genre.Name
            }).ToList();
        ...
        static async Task<Created<GenreDTO>> Create(CreateUpdateGenreDTO creatupdaetgenreDTO, IGenreRepository genreRepository, IOutputCacheStore cachecleanig)
        {
